...
//        newManagedObject.setValue(NSDate.date(), forKey: "timeStamp")
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let entity = NSEntityDescription.entityForName("Repo", inManagedObjectContext: self.managedObjectContext)
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar!) {
        ConnectionManagerGlobalVariable.reposForSearchString(searchBar.text, completion: {(
            result: AnyObject) in
            if let repoArray: Array< Dictionary<String, String> > =  result as? Array< Dictionary<String, String> > {
                NSLog("%@", repoArray)
            }
        })
    }
